...
#> 1  2015         1 Aguascali~ La vid~ Homici~ Homici~ Con ar~     3       0     2
#> 2  2015         1 Aguascali~ La vid~ Homici~ Homici~ Con ar~     1       1     0
#> 3  2015         1 Aguascali~ La vid~ Homici~ Homici~ Con ot~     0       0     2
#> 4  2015         1 Aguascali~ La vid~ Homici~ Homici~ No esp~     2       0     0
#> 5  2015         1 Aguascali~ La vid~ Homici~ Homici~ Con ar~     0       0     0
#> 6  2015         1 Aguascali~ La vid~ Homici~ Homici~ Con ar~     0       0     0
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(datos }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{gather}\NormalTok{(}\StringTok{"mes"}\NormalTok{,}\StringTok{"total\_delitos"}\NormalTok{,Enero}\SpecialCharTok{:}\NormalTok{Diciembre) }\SpecialCharTok{\%\textgreater{}\%} 
